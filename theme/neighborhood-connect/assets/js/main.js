  ...
  const LanguageManager = {
    ...
    dict: {
      en: {
        ...
        'nav-logout':     'Log Out',
        // Archive heroes
        'services-title': 'Society Services On Demand',
        'services-sub':   'In-house teams for plumbing, electrical, cleaning, tiffin and more — dispatched by Canal View Society.',
        // Buttons & labels
        'btn-rsvp':       'RSVP',
      ...
      ur: {
        ...
        'nav-issues':     ' مسائل',
        'nav-community':  ' محلہ',
        'nav-neighborhood': ' محلہ',
        'nav-login':      'لاگ ان',
        'nav-join':       'مفت شامل ہوں',
        'nav-profile':    'میری پروفائل',
        'nav-logout':     'لاگ آؤٹ',
        // Archive heroes
        'services-title': 'کینال ویو سوسائٹی خدمات',
        'services-sub':   'کینال ویو سوسائٹی کا اندرونی پلمبر، الیکٹریشن، صفائی، ٹفن اور گروسری ٹیم — درخواست پر آپ کے دروازے تک۔',
        // Buttons & labels
        'btn-rsvp':       'حاضری',
